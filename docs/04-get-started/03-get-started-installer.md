...
1. 从列表中下载获得最新 `tar.gz` 安装包，请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
...
1. 从列表中下载获得最新的 `.rpm` 安装包。请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
...
1. 从列表中下载获得最新的 `macOS` 安装包 (.pkg)。请在弹出的对话框中，填写您的邮箱地址，我们会将下载链接发送到您的邮箱。
